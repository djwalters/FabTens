function [F2,F2Ci,F4,F4Ci,meanBondRad,meanGrainRad,coordNum,shapeFac] = ContactTensor(FileIn,varargin)
...
switch FileIn
    case 1
        ...
        % Read files of stereological data generated by Mike Eden's SSAnalyzer
